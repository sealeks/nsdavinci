...
${OBJECTDIR}/_ext/1986307458/archive_stream.o: /F/Project/davinci/include/iso/archive_stream.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -D_WIN32_WINNT=0x0501 -DDVNCI_DEDUG -I../../include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1986307458/archive_stream.o /F/Project/davinci/include/iso/archive_stream.cpp

${OBJECTDIR}/_ext/1060574097/itu_X690.o: /F/Project/davinci/include/iso/asn/itu_X690.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1060574097
	${RM} $@.d
	$(COMPILE.cc) -O2 -D_WIN32_WINNT=0x0501 -DDVNCI_DEDUG -I../../include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1060574097/itu_X690.o /F/Project/davinci/include/iso/asn/itu_X690.cpp
