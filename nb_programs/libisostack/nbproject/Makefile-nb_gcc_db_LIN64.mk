...
${OBJECTDIR}/_ext/1901903102/iso.o: ../../include/iso/iso.cpp 
	...
	$(COMPILE.cc) -g -DDVNCI_DEDUG -I../../include -o ${OBJECTDIR}/_ext/1901903102/iso.o ../../include/iso/iso.cpp

${OBJECTDIR}/_ext/894376469/asnbase.o: ../../include/iso/asn/asnbase.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/894376469
	$(COMPILE.cc) -g -DDVNCI_DEDUG -I../../include -o ${OBJECTDIR}/_ext/894376469/asnbase.o ../../include/iso/asn/asnbase.cpp

${OBJECTDIR}/_ext/894376469/itu_X690.o: ../../include/iso/asn/itu_X690.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/894376469
	$(COMPILE.cc) -g -DDVNCI_DEDUG -I../../include -o ${OBJECTDIR}/_ext/894376469/itu_X690.o ../../include/iso/asn/itu_X690.cpp
...
${OBJECTDIR}/_ext/1901903102/archive_stream.o: ../../include/iso/archive_stream.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1901903102
	$(COMPILE.cc) -g -DDVNCI_DEDUG -I../../include -o ${OBJECTDIR}/_ext/1901903102/archive_stream.o ../../include/iso/archive_stream.cpp

${OBJECTDIR}/_ext/1901903102/rfc1006.o: ../../include/iso/rfc1006.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1901903102
	$(COMPILE.cc) -g -DDVNCI_DEDUG -I../../include -o ${OBJECTDIR}/_ext/1901903102/rfc1006.o ../../include/iso/rfc1006.cpp
