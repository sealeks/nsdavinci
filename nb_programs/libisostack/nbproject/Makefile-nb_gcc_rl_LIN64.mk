...
${OBJECTDIR}/_ext/1170440020/meta.o: ../../include/meta/meta.cpp 
	...
	$(COMPILE.cc) -O2 -Wall -I../../include -o ${OBJECTDIR}/_ext/1170440020/meta.o ../../include/meta/meta.cpp

${OBJECTDIR}/_ext/1170440020/pugixml.o: ../../include/meta/pugixml.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1170440020
	$(COMPILE.cc) -O2 -Wall -I../../include -o ${OBJECTDIR}/_ext/1170440020/pugixml.o ../../include/meta/pugixml.cpp

${OBJECTDIR}/_ext/1170440020/pugixpath.o: ../../include/meta/pugixpath.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1170440020
	$(COMPILE.cc) -O2 -Wall -I../../include -o ${OBJECTDIR}/_ext/1170440020/pugixpath.o ../../include/meta/pugixpath.cpp
