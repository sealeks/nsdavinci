...
${OBJECTDIR}/_ext/148756256/main.o: ../../include_program/consol_admin/main.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -I../../include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/148756256/main.o ../../include_program/consol_admin/main.cpp

${OBJECTDIR}/_ext/148756256/adminconsol.o: ../../include_program/consol_admin/adminconsol.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/148756256
	${RM} $@.d
	$(COMPILE.cc) -g -I../../include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/148756256/adminconsol.o ../../include_program/consol_admin/adminconsol.cpp
