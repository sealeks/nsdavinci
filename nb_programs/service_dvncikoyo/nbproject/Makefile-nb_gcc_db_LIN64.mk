...
../../bin/${CND_CONF}/service_dvncikoyo_db.exe: ${OBJECTFILES}
	...
	${LINK.cc} -o ../../bin/${CND_CONF}/service_dvncikoyo_db ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/_ext/1232915786/directnet_protocol.o: ../../include/driverspec/directnet_protocol.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -DDVNCI_DEDUG -I../../include -fno-strict-aliasing -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1232915786/directnet_protocol.o ../../include/driverspec/directnet_protocol.cpp

${OBJECTDIR}/_ext/1232915786/modbus_protocol.o: ../../include/driverspec/modbus_protocol.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1232915786
	${RM} $@.d
	$(COMPILE.cc) -g -DDVNCI_DEDUG -I../../include -fno-strict-aliasing -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1232915786/modbus_protocol.o ../../include/driverspec/modbus_protocol.cpp
...
${OBJECTDIR}/_ext/1261136976/koyo_detail.o: ../../include_program/service_dvncikoyo/koyo_detail.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -DDVNCI_DEDUG -I../../include -fno-strict-aliasing -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1261136976/koyo_detail.o ../../include_program/service_dvncikoyo/koyo_detail.cpp

${OBJECTDIR}/_ext/1261136976/main.o: ../../include_program/service_dvncikoyo/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1261136976
	${RM} $@.d
	$(COMPILE.cc) -g -DDVNCI_DEDUG -I../../include -fno-strict-aliasing -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1261136976/main.o ../../include_program/service_dvncikoyo/main.cpp
