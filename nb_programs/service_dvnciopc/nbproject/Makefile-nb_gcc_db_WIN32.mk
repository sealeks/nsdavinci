...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ../../bin/${CND_CONF}/service_dvnciopc_db.exe

../../bin/${CND_CONF}/service_dvnciopc_db.exe: ${OBJECTFILES}
	${MKDIR} -p ../../bin/${CND_CONF}
	${LINK.cc} -o ../../bin/${CND_CONF}/service_dvnciopc_db ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
${OBJECTDIR}/_ext/513511340/dvnci_opc_subsciptor.o: ../../include_program/service_dvnciopc/dvnci_opc_subsciptor.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -D_WIN32_WINNT=0x0501 -DDVNCI_DEDUG -I../../include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/513511340/dvnci_opc_subsciptor.o ../../include_program/service_dvnciopc/dvnci_opc_subsciptor.cpp

${OBJECTDIR}/_ext/513511340/opcintf.o: ../../include_program/service_dvnciopc/opcintf.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/513511340
	${RM} $@.d
	$(COMPILE.cc) -O2 -D_WIN32_WINNT=0x0501 -DDVNCI_DEDUG -I../../include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/513511340/opcintf.o ../../include_program/service_dvnciopc/opcintf.cpp

${OBJECTDIR}/_ext/513511340/main.o: ../../include_program/service_dvnciopc/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/513511340
	${RM} $@.d
	$(COMPILE.cc) -O2 -D_WIN32_WINNT=0x0501 -DDVNCI_DEDUG -I../../include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/513511340/main.o ../../include_program/service_dvnciopc/main.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ../../bin/${CND_CONF}/service_dvnciopc_db.exe
