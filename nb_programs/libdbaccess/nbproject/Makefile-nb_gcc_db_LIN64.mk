...
${OBJECTDIR}/_ext/340415863/db_task_executor.o: ../../include/dbaccess/db_task_executor.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -DDVNCI_DEDUG -I../../include -I../../include/soci -fno-strict-aliasing -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/340415863/db_task_executor.o ../../include/dbaccess/db_task_executor.cpp

${OBJECTDIR}/_ext/340415863/dbconnectionfactory.o: ../../include/dbaccess/dbconnectionfactory.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/340415863
	${RM} $@.d
	$(COMPILE.cc) -g -DDVNCI_DEDUG -I../../include -I../../include/soci -fno-strict-aliasing -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/340415863/dbconnectionfactory.o ../../include/dbaccess/dbconnectionfactory.cpp

${OBJECTDIR}/_ext/340415863/dbdriver.o: ../../include/dbaccess/dbdriver.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/340415863
	${RM} $@.d
	$(COMPILE.cc) -g -DDVNCI_DEDUG -I../../include -I../../include/soci -fno-strict-aliasing -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/340415863/dbdriver.o ../../include/dbaccess/dbdriver.cpp

${OBJECTDIR}/_ext/340415863/dbpsgrdriver.o: ../../include/dbaccess/dbpsgrdriver.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/340415863
	${RM} $@.d
	$(COMPILE.cc) -g -DDVNCI_DEDUG -I../../include -I../../include/soci -fno-strict-aliasing -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/340415863/dbpsgrdriver.o ../../include/dbaccess/dbpsgrdriver.cpp
