...
${OBJECTDIR}/_ext/340415863/dbdriver.o: ../../include/dbaccess/dbdriver.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -DDVNCI_DEDUG -D_WIN32_WINNT=0x0501 -I../../include -I../../include/soci -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/340415863/dbdriver.o ../../include/dbaccess/dbdriver.cpp

${OBJECTDIR}/_ext/340415863/dbconnectionfactory.o: ../../include/dbaccess/dbconnectionfactory.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/340415863
	${RM} $@.d
	$(COMPILE.cc) -O2 -DDVNCI_DEDUG -D_WIN32_WINNT=0x0501 -I../../include -I../../include/soci -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/340415863/dbconnectionfactory.o ../../include/dbaccess/dbconnectionfactory.cpp

${OBJECTDIR}/_ext/340415863/dbpsgrdriver.o: ../../include/dbaccess/dbpsgrdriver.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/340415863
	${RM} $@.d
	$(COMPILE.cc) -O2 -DDVNCI_DEDUG -D_WIN32_WINNT=0x0501 -I../../include -I../../include/soci -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/340415863/dbpsgrdriver.o ../../include/dbaccess/dbpsgrdriver.cpp

${OBJECTDIR}/_ext/340415863/db_task_executor.o: ../../include/dbaccess/db_task_executor.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/340415863
	${RM} $@.d
	$(COMPILE.cc) -O2 -DDVNCI_DEDUG -D_WIN32_WINNT=0x0501 -I../../include -I../../include/soci -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/340415863/db_task_executor.o ../../include/dbaccess/db_task_executor.cpp
