...
${OBJECTDIR}/_ext/513500399/main.o: ../../include_program/service_dvncidde/main.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -Wall -D_WIN32_WINNT=0x0501 -I../../include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/513500399/main.o ../../include_program/service_dvncidde/main.cpp

${OBJECTDIR}/_ext/513500399/ddeintf.o: ../../include_program/service_dvncidde/ddeintf.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/513500399
	${RM} $@.d
	$(COMPILE.cc) -O2 -Wall -D_WIN32_WINNT=0x0501 -I../../include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/513500399/ddeintf.o ../../include_program/service_dvncidde/ddeintf.cpp

${OBJECTDIR}/_ext/513500399/dvnci_dde_subsciptor.o: ../../include_program/service_dvncidde/dvnci_dde_subsciptor.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/513500399
	${RM} $@.d
	$(COMPILE.cc) -O2 -Wall -D_WIN32_WINNT=0x0501 -I../../include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/513500399/dvnci_dde_subsciptor.o ../../include_program/service_dvncidde/dvnci_dde_subsciptor.cpp
