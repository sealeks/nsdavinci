...
${OBJECTDIR}/_ext/1955588125/localnetintf.o: ../../include/netinterface/localnetintf.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -Wall -D_WIN32_WINNT=0x0501 -I../../include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1955588125/localnetintf.o ../../include/netinterface/localnetintf.cpp

${OBJECTDIR}/_ext/1955588125/dvnci_net_subsciptor.o: ../../include/netinterface/dvnci_net_subsciptor.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1955588125
	${RM} $@.d
	$(COMPILE.cc) -O2 -Wall -D_WIN32_WINNT=0x0501 -I../../include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1955588125/dvnci_net_subsciptor.o ../../include/netinterface/dvnci_net_subsciptor.cpp

${OBJECTDIR}/_ext/1955588125/netintf.o: ../../include/netinterface/netintf.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1955588125
	${RM} $@.d
	$(COMPILE.cc) -O2 -Wall -D_WIN32_WINNT=0x0501 -I../../include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1955588125/netintf.o ../../include/netinterface/netintf.cpp

${OBJECTDIR}/_ext/1955588125/netsession.o: ../../include/netinterface/netsession.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1955588125
	${RM} $@.d
	$(COMPILE.cc) -O2 -Wall -D_WIN32_WINNT=0x0501 -I../../include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1955588125/netsession.o ../../include/netinterface/netsession.cpp

${OBJECTDIR}/_ext/1955588125/remotenetintf.o: ../../include/netinterface/remotenetintf.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1955588125
	${RM} $@.d
	$(COMPILE.cc) -O2 -Wall -D_WIN32_WINNT=0x0501 -I../../include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1955588125/remotenetintf.o ../../include/netinterface/remotenetintf.cpp
