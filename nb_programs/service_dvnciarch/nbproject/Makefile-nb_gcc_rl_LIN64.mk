...
${OBJECTDIR}/_ext/1261432692/dbwriter.o: ../../include_program/service_dvnciarch/dbwriter.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -Wall -I../../include -fno-strict-aliasing -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1261432692/dbwriter.o ../../include_program/service_dvnciarch/dbwriter.cpp

${OBJECTDIR}/_ext/1261432692/main.o: ../../include_program/service_dvnciarch/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1261432692
	${RM} $@.d
	$(COMPILE.cc) -O2 -Wall -I../../include -fno-strict-aliasing -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1261432692/main.o ../../include_program/service_dvnciarch/main.cpp

${OBJECTDIR}/_ext/1261432692/reporttype_executor.o: ../../include_program/service_dvnciarch/reporttype_executor.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1261432692
	${RM} $@.d
	$(COMPILE.cc) -O2 -Wall -I../../include -fno-strict-aliasing -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1261432692/reporttype_executor.o ../../include_program/service_dvnciarch/reporttype_executor.cpp
