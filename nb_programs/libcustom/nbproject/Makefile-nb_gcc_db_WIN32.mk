...
${OBJECTDIR}/_ext/217049176/extnetintf.o: ../../include/custom/extnetintf.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -DDVNCI_DEDUG -D_WIN32_WINNT=0x0601 -I../../include -I${BOOST_DIR} -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/217049176/extnetintf.o ../../include/custom/extnetintf.cpp

${OBJECTDIR}/_ext/217049176/gui_executor.o: ../../include/custom/gui_executor.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/217049176
	${RM} $@.d
	$(COMPILE.cc) -g -DDVNCI_DEDUG -D_WIN32_WINNT=0x0601 -I../../include -I${BOOST_DIR} -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/217049176/gui_executor.o ../../include/custom/gui_executor.cpp

${OBJECTDIR}/_ext/217049176/localnetintf.o: ../../include/custom/localnetintf.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/217049176
	${RM} $@.d
	$(COMPILE.cc) -g -DDVNCI_DEDUG -D_WIN32_WINNT=0x0601 -I../../include -I${BOOST_DIR} -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/217049176/localnetintf.o ../../include/custom/localnetintf.cpp

${OBJECTDIR}/_ext/217049176/netintf.o: ../../include/custom/netintf.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/217049176
	${RM} $@.d
	$(COMPILE.cc) -g -DDVNCI_DEDUG -D_WIN32_WINNT=0x0601 -I../../include -I${BOOST_DIR} -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/217049176/netintf.o ../../include/custom/netintf.cpp

${OBJECTDIR}/_ext/217049176/netsession.o: ../../include/custom/netsession.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/217049176
	${RM} $@.d
	$(COMPILE.cc) -g -DDVNCI_DEDUG -D_WIN32_WINNT=0x0601 -I../../include -I${BOOST_DIR} -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/217049176/netsession.o ../../include/custom/netsession.cpp

${OBJECTDIR}/_ext/217049176/remotenetintf.o: ../../include/custom/remotenetintf.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/217049176
	${RM} $@.d
	$(COMPILE.cc) -g -DDVNCI_DEDUG -D_WIN32_WINNT=0x0601 -I../../include -I${BOOST_DIR} -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/217049176/remotenetintf.o ../../include/custom/remotenetintf.cpp
