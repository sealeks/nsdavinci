...
${OBJECTDIR}/_ext/431270180/interface_proccesstmpl.o: ../../include/kernel/interface_proccesstmpl.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/431270180
	${RM} $@.d
	$(COMPILE.cc) -O2 -DDVNCI_DEDUG -D_WIN32_WINNT=0x0501 -I../../include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/431270180/interface_proccesstmpl.o ../../include/kernel/interface_proccesstmpl.cpp
...
${OBJECTDIR}/_ext/431270180/driver_blockgenerator.o: ../../include/kernel/driver_blockgenerator.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/431270180
	${RM} $@.d
	$(COMPILE.cc) -O2 -DDVNCI_DEDUG -D_WIN32_WINNT=0x0501 -I../../include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/431270180/driver_blockgenerator.o ../../include/kernel/driver_blockgenerator.cpp
