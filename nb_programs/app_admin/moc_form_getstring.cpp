...
**
** Created: Wed 29. Jun 16:19:39 2011
...
static const char qt_meta_stringdata_dvnci__admin__form_getstring[] = {
    "dvnci::admin::form_getstring\0"
};

const QMetaObject dvnci::admin::form_getstring::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_dvnci__admin__form_getstring,
      qt_meta_data_dvnci__admin__form_getstring, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &dvnci::admin::form_getstring::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_dvnci__admin__form_getstring))
