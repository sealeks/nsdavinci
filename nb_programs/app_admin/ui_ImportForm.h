/********************************************************************************
** Form generated from reading UI file 'ImportForm.ui'
**
...
#ifndef UI_IMPORTFORM_H
#define UI_IMPORTFORM_H
...
public:
    ...
    void setupUi(QDialog *ImportForm)
    {
        if (ImportForm->objectName().isEmpty())
            ImportForm->setObjectName(QString::fromUtf8("ImportForm"));
        ImportForm->setWindowModality(Qt::ApplicationModal);
        ImportForm->resize(969, 627);
        ImportForm->setModal(true);
        verticalLayout_6 = new QVBoxLayout(ImportForm);
        verticalLayout_6->setObjectName(QString::fromUtf8("verticalLayout_6"));
        verticalLayout = new QVBoxLayout();
        verticalLayout->setObjectName(QString::fromUtf8("verticalLayout"));
        splitter = new QSplitter(ImportForm);
        ...
        retranslateUi(ImportForm);
        QObject::connect(buttonBox, SIGNAL(accepted()), ImportForm, SLOT(accept()));
        QObject::connect(buttonBox, SIGNAL(rejected()), ImportForm, SLOT(reject()));

        QMetaObject::connectSlotsByName(ImportForm);
    } // setupUi

    void retranslateUi(QDialog *ImportForm)
    {
        ImportForm->setWindowTitle(QApplication::translate("ImportForm", "ImportForm", 0, QApplication::UnicodeUTF8));
        btndeletetags->setText(QApplication::translate("ImportForm", "...", 0, QApplication::UnicodeUTF8));
        btnprefixtag->setText(QApplication::translate("ImportForm", "...", 0, QApplication::UnicodeUTF8));
        labeltag->setText(QApplication::translate("ImportForm", "TextLabel", 0, QApplication::UnicodeUTF8));
        btndeletegroups->setText(QApplication::translate("ImportForm", "...", 0, QApplication::UnicodeUTF8));
        labelgroup->setText(QApplication::translate("ImportForm", "TextLabel", 0, QApplication::UnicodeUTF8));
        btndeleteagroups->setText(QApplication::translate("ImportForm", "...", 0, QApplication::UnicodeUTF8));
        labelagroup->setText(QApplication::translate("ImportForm", "TextLabel", 0, QApplication::UnicodeUTF8));
        btndeleteusers->setText(QApplication::translate("ImportForm", "...", 0, QApplication::UnicodeUTF8));
        labeluser->setText(QApplication::translate("ImportForm", "TextLabel", 0, QApplication::UnicodeUTF8));
        revwritecheckbox->setText(QApplication::translate("ImportForm", "rewrite", 0, QApplication::UnicodeUTF8));
    } // retranslateUi

};

namespace Ui {
    class ImportForm: public Ui_ImportForm {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_IMPORTFORM_H
