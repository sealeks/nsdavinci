...
${OBJECTDIR}/_ext/692605831/extmmsintf.o: ../../include_program/service_mms/extmmsintf.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -I../../include -fno-strict-aliasing -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/692605831/extmmsintf.o ../../include_program/service_mms/extmmsintf.cpp

${OBJECTDIR}/_ext/692605831/main.o: ../../include_program/service_mms/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/692605831
	${RM} $@.d
	$(COMPILE.cc) -g -I../../include -fno-strict-aliasing -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/692605831/main.o ../../include_program/service_mms/main.cpp

${OBJECTDIR}/_ext/692605831/mmsintf.o: ../../include_program/service_mms/mmsintf.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/692605831
	${RM} $@.d
	$(COMPILE.cc) -g -I../../include -fno-strict-aliasing -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/692605831/mmsintf.o ../../include_program/service_mms/mmsintf.cpp

${OBJECTDIR}/_ext/692605831/mmsioclient.o: ../../include_program/service_mms/mmsioclient.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/692605831
	${RM} $@.d
	$(COMPILE.cc) -g -I../../include -fno-strict-aliasing -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/692605831/mmsioclient.o ../../include_program/service_mms/mmsioclient.cpp

${OBJECTDIR}/_ext/692605831/mmsserver.o: ../../include_program/service_mms/mmsserver.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/692605831
	${RM} $@.d
	$(COMPILE.cc) -g -I../../include -fno-strict-aliasing -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/692605831/mmsserver.o ../../include_program/service_mms/mmsserver.cpp
