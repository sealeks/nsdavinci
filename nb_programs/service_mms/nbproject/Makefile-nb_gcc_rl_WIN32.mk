...
${OBJECTDIR}/_ext/692605831/extmmsintf.o: ../../include_program/service_mms/extmmsintf.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -D_WIN32_WINNT=0x0501 -I../../include -I../../../itu-t/include -mthreads -fno-strict-aliasing -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/692605831/extmmsintf.o ../../include_program/service_mms/extmmsintf.cpp
