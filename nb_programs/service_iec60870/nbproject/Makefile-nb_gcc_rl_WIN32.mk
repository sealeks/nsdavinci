...
${OBJECTDIR}/_ext/1923264132/iec60870_detail.o: ../../include_program/service_iec60870/iec60870_detail.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -DBOOST_ASIO_ENABLE_CANCELIO -D_WIN32_WINNT=0x0501 -I../../include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1923264132/iec60870_detail.o ../../include_program/service_iec60870/iec60870_detail.cpp
