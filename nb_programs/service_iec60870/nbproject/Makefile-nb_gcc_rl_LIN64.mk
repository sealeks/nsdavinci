...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ../../bin/${CND_CONF}/service_iec60870.exe

../../bin/${CND_CONF}/service_iec60870.exe: ${OBJECTFILES}
	${MKDIR} -p ../../bin/${CND_CONF}
	${LINK.cc} -o ../../bin/${CND_CONF}/service_iec60870 ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/_ext/1923264132/extiec60870intf.o: ../../include_program/service_iec60870/extiec60870intf.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -Wall -s -I../../include -fno-strict-aliasing -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1923264132/extiec60870intf.o ../../include_program/service_iec60870/extiec60870intf.cpp

${OBJECTDIR}/_ext/1923264132/iec60870_104PM.o: ../../include_program/service_iec60870/iec60870_104PM.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1923264132
	${RM} $@.d
	$(COMPILE.cc) -O2 -Wall -s -I../../include -fno-strict-aliasing -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1923264132/iec60870_104PM.o ../../include_program/service_iec60870/iec60870_104PM.cpp

${OBJECTDIR}/_ext/1923264132/iec60870_PM.o: ../../include_program/service_iec60870/iec60870_PM.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1923264132
	${RM} $@.d
	$(COMPILE.cc) -O2 -Wall -s -I../../include -fno-strict-aliasing -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1923264132/iec60870_PM.o ../../include_program/service_iec60870/iec60870_PM.cpp

${OBJECTDIR}/_ext/1923264132/iec60870_protocol.o: ../../include_program/service_iec60870/iec60870_protocol.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1923264132
	${RM} $@.d
	$(COMPILE.cc) -O2 -Wall -s -I../../include -fno-strict-aliasing -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1923264132/iec60870_protocol.o ../../include_program/service_iec60870/iec60870_protocol.cpp

${OBJECTDIR}/_ext/1923264132/main.o: ../../include_program/service_iec60870/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1923264132
	${RM} $@.d
	$(COMPILE.cc) -O2 -Wall -s -I../../include -fno-strict-aliasing -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1923264132/main.o ../../include_program/service_iec60870/main.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ../../bin/${CND_CONF}/service_iec60870.exe
