...
${OBJECTDIR}/_ext/1923264132/iec60870ioclient.o: ../../include_program/service_iec60870/iec60870ioclient.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1923264132
	${RM} $@.d
	$(COMPILE.cc) -O2 -Wall -s -I../../include -fno-strict-aliasing -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1923264132/iec60870ioclient.o ../../include_program/service_iec60870/iec60870ioclient.cpp
