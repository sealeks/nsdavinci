...
${OBJECTDIR}/_ext/1923264132/modbus_detail.o: ../../include_program/service_iec60870/modbus_detail.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1923264132
	${RM} $@.d
	$(COMPILE.cc) -g -s -DBOOST_ASIO_ENABLE_CANCELIO -DDVNCI_DEDUG -D_WIN32_WINNT=0x0501 -I../../include -mthreads -fno-strict-aliasing -static -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1923264132/modbus_detail.o ../../include_program/service_iec60870/modbus_detail.cpp
