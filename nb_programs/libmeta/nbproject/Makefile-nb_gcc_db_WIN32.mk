...
${OBJECTDIR}/_ext/1170440020/meta.o: ../../include/meta/meta.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -D_WIN32_WINNT=0x0501 -DDVNCI_DEDUG -I../../include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1170440020/meta.o ../../include/meta/meta.cpp

${OBJECTDIR}/_ext/1170440020/pugixml.o: ../../include/meta/pugixml.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1170440020
	${RM} $@.d
	$(COMPILE.cc) -O2 -D_WIN32_WINNT=0x0501 -DDVNCI_DEDUG -I../../include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1170440020/pugixml.o ../../include/meta/pugixml.cpp

${OBJECTDIR}/_ext/1170440020/pugixpath.o: ../../include/meta/pugixpath.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1170440020
	${RM} $@.d
	$(COMPILE.cc) -O2 -D_WIN32_WINNT=0x0501 -DDVNCI_DEDUG -I../../include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1170440020/pugixpath.o ../../include/meta/pugixpath.cpp
