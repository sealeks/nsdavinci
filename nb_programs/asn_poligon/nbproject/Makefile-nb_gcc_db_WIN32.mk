...
LDLIBSOPTIONS=-L../../lib/boost/${CND_CONF} -L../../lib/${CND_CONF} -lnskernel -lisostack -lnskernel -lboost_date_time -lboost_filesystem -lboost_iostreams -lboost_program_options -lboost_random -lboost_regex -lboost_serialization -lboost_signals -lboost_system -lboost_thread -lboost_chrono -lboost_wserialization -lole32 -lwsock32 -loleaut32 -lws2_32

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ../../bin/${CND_CONF}/asn_poligon.exe

../../bin/${CND_CONF}/asn_poligon.exe: ${OBJECTFILES}
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ../../bin/${CND_CONF}/asn_poligon.exe
