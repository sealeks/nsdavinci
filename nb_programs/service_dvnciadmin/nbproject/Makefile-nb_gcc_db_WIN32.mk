...
${OBJECTDIR}/_ext/450115111/main.o: ../../include_program/service_dvnciadmin/main.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -D_WIN32_WINNT=0x0501 -DDVNCI_DEDUG -I../../include -I../../include/pugixml -mthreads -fno-strict-aliasing -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/450115111/main.o ../../include_program/service_dvnciadmin/main.cpp
