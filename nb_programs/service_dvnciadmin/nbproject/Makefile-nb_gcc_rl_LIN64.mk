...
${OBJECTDIR}/_ext/450115111/main.o: ../../include_program/service_dvnciadmin/main.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -I../../include -I../../include/pugixml -fno-strict-aliasing -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/450115111/main.o ../../include_program/service_dvnciadmin/main.cpp
