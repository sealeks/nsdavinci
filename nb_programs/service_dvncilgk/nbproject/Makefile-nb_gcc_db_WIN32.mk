...
${OBJECTDIR}/_ext/513508186/mg_protocol.o: ../../include_program/service_dvncilgk/mg_protocol.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -D_WIN32_WINNT=0x0501 -DDVNCI_DEDUG -DBOOST_ASIO_ENABLE_CANCELIO -I../../include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/513508186/mg_protocol.o ../../include_program/service_dvncilgk/mg_protocol.cpp

${OBJECTDIR}/_ext/513508186/iek1177_protocol.o: ../../include_program/service_dvncilgk/iek1177_protocol.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/513508186
	${RM} $@.d
	$(COMPILE.cc) -O2 -D_WIN32_WINNT=0x0501 -DDVNCI_DEDUG -DBOOST_ASIO_ENABLE_CANCELIO -I../../include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/513508186/iek1177_protocol.o ../../include_program/service_dvncilgk/iek1177_protocol.cpp

${OBJECTDIR}/_ext/513508186/lgk_detail.o: ../../include_program/service_dvncilgk/lgk_detail.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/513508186
	${RM} $@.d
	$(COMPILE.cc) -O2 -D_WIN32_WINNT=0x0501 -DDVNCI_DEDUG -DBOOST_ASIO_ENABLE_CANCELIO -I../../include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/513508186/lgk_detail.o ../../include_program/service_dvncilgk/lgk_detail.cpp

${OBJECTDIR}/_ext/513508186/main.o: ../../include_program/service_dvncilgk/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/513508186
	${RM} $@.d
	$(COMPILE.cc) -O2 -D_WIN32_WINNT=0x0501 -DDVNCI_DEDUG -DBOOST_ASIO_ENABLE_CANCELIO -I../../include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/513508186/main.o ../../include_program/service_dvncilgk/main.cpp
