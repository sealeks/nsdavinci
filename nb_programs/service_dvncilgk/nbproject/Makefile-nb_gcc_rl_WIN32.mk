...
../../bin/${CND_CONF}/service_dvncilgk.exe: ${OBJECTFILES}
	...
	${LINK.cc} -mthreads -fno-strict-aliasing -o ../../bin/${CND_CONF}/service_dvncilgk ${OBJECTFILES} ${LDLIBSOPTIONS} 

${OBJECTDIR}/_ext/513508186/mg_protocol.o: ../../include_program/service_dvncilgk/mg_protocol.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/513508186
	${RM} $@.d
	$(COMPILE.cc) -O2 -D_WIN32_WINNT=0x0501 -DBOOST_ASIO_ENABLE_CANCELIO -I../../include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/513508186/mg_protocol.o ../../include_program/service_dvncilgk/mg_protocol.cpp

${OBJECTDIR}/_ext/513508186/iek1177_protocol.o: ../../include_program/service_dvncilgk/iek1177_protocol.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/513508186
	${RM} $@.d
	$(COMPILE.cc) -O2 -D_WIN32_WINNT=0x0501 -DBOOST_ASIO_ENABLE_CANCELIO -I../../include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/513508186/iek1177_protocol.o ../../include_program/service_dvncilgk/iek1177_protocol.cpp
