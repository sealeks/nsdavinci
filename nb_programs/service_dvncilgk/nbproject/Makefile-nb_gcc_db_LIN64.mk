...
${OBJECTDIR}/_ext/513508186/lgk_detail.o: ../../include_program/service_dvncilgk/lgk_detail.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -DDVNCI_DEDUG -I../../include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/513508186/lgk_detail.o ../../include_program/service_dvncilgk/lgk_detail.cpp

${OBJECTDIR}/_ext/513508186/main.o: ../../include_program/service_dvncilgk/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/513508186
	${RM} $@.d
	$(COMPILE.cc) -g -DDVNCI_DEDUG -I../../include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/513508186/main.o ../../include_program/service_dvncilgk/main.cpp
