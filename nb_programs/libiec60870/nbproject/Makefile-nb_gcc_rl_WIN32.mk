...
${OBJECTDIR}/_ext/1834619689/iec60870_104PM.o: ../../include/iec60870/iec60870_104PM.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -Wall -D_WIN32_WINNT=0x0501 -I../../include -I${BOOST_DIR} -mthreads -fno-strict-aliasing -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1834619689/iec60870_104PM.o ../../include/iec60870/iec60870_104PM.cpp

${OBJECTDIR}/_ext/1834619689/iec60870_PM.o: ../../include/iec60870/iec60870_PM.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1834619689
	${RM} $@.d
	$(COMPILE.cc) -O2 -Wall -D_WIN32_WINNT=0x0501 -I../../include -I${BOOST_DIR} -mthreads -fno-strict-aliasing -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1834619689/iec60870_PM.o ../../include/iec60870/iec60870_PM.cpp

${OBJECTDIR}/_ext/1834619689/iec60870_detail.o: ../../include/iec60870/iec60870_detail.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1834619689
	${RM} $@.d
	$(COMPILE.cc) -O2 -Wall -D_WIN32_WINNT=0x0501 -I../../include -I${BOOST_DIR} -mthreads -fno-strict-aliasing -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1834619689/iec60870_detail.o ../../include/iec60870/iec60870_detail.cpp

${OBJECTDIR}/_ext/1834619689/iec60870_factory.o: ../../include/iec60870/iec60870_factory.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1834619689
	${RM} $@.d
	$(COMPILE.cc) -O2 -Wall -D_WIN32_WINNT=0x0501 -I../../include -I${BOOST_DIR} -mthreads -fno-strict-aliasing -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1834619689/iec60870_factory.o ../../include/iec60870/iec60870_factory.cpp

${OBJECTDIR}/_ext/1834619689/iec60870_protocol.o: ../../include/iec60870/iec60870_protocol.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1834619689
	${RM} $@.d
	$(COMPILE.cc) -O2 -Wall -D_WIN32_WINNT=0x0501 -I../../include -I${BOOST_DIR} -mthreads -fno-strict-aliasing -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1834619689/iec60870_protocol.o ../../include/iec60870/iec60870_protocol.cpp
