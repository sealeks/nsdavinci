...
${OBJECTDIR}/_ext/2048960737/main.o: ../../include_program/test_poligon/main.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -D_WIN32_WINNT=0x0501 -DDVNCI_DEDUG -I../../include -mthreads -fno-strict-aliasing -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/2048960737/main.o ../../include_program/test_poligon/main.cpp
