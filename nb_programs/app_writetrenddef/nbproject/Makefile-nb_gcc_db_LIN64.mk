...
${OBJECTDIR}/_ext/863468359/writebase.o: ../../include_program/app_writetrenddef/writebase.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -DDVNCI_DEDUG -I../../include -fno-strict-aliasing -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/863468359/writebase.o ../../include_program/app_writetrenddef/writebase.cpp
