...
LDLIBSOPTIONS=-L../../lib/boost/${CND_CONF} -L../../lib/${CND_CONF} -ldbaccess -lnskernel -lsoci -lboost_date_time -lboost_filesystem -lboost_iostreams -lboost_program_options -lboost_random -lboost_regex -lboost_serialization -lboost_signals -lboost_system -lboost_thread -lboost_wserialization -lole32 -loleaut32 -luuid -lwsnmp32 -lwsock32
...
${OBJECTDIR}/_ext/863468359/writebase.o: ../../include_program/app_writetrenddef/writebase.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -DDVNCI_DEDUG -D_WIN32_WINNT=0x0501 -I../../include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/863468359/writebase.o ../../include_program/app_writetrenddef/writebase.cpp
