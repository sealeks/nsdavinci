...
namespace prot9506 {
    ...
    public:
        ...
        :  super_type(io_service,  psel , init_synaxes()), invoke_id_(0) {
        }
        ...
        : super_type(io_service, endpoint, psel.sselector()), invoke_id_(0)  {
        }
    ...
    private:
        ...
        public:
            ...
            confirm_request_op(stream_socket* socket , ConfirmRequestHandler handler, operation_type operatetion ) :
            ...
            void operator()(const boost::system::error_code& ec) {
                if (!ec) {
                    switch (state) {
                        ...
                        {
                            state = response;
                            socket_->super_type::async_respond(boost::bind(& confirm_request_op<ConfirmRequestHandler, REQ, RSP, REQID, RSPID >::run, *this , boost::asio::placeholders::error));
                            return;
                        }
                        case response:
                        {
    ...
    public:
        ...
        void async_confirm_request(boost::shared_ptr<confirmed_operation<REQ, RSP, REQID, RSPID > > operation,
            ...
            super_type::async_request(boost::bind(& confirm_request_op<ConfirmRequestHandler , REQ, RSP, REQID, RSPID >::run,
                    confirm_request_op< ConfirmRequestHandler , REQ, RSP, REQID, RSPID  > ( const_cast<stream_socket*> (this), handler, operation), boost::asio::placeholders::error));
