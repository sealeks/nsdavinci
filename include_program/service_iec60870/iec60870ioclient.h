...
namespace prot9506 {
    ...
    const std::size_t IEC60850DEFAULT_TIMENOUT = 1000;
    ...
    public:
        ...
        std::size_t tmo = IEC60850DEFAULT_TIMENOUT);
        void disconnect();
                ...
                if (is_error) {
                    if ((error_cod == 10054) || (error_cod == 10053) ||
                        ...
                        if (error_cod == boost::itu::ER_BEDSEQ.value()) {
                                    ...
                                    throw boost::itu::ER_NOLINK;//dvnci::dvncierror(dvnci::ERROR_FAILNET_CONNECTED);
                        }
