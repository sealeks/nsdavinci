...
eleclib.valueset_click =  function (el, nm, width){
    ...
    try{
        ...
        var body = eleclib.get_popupbody(el,width,parseFloat(width)* 2.05, 
...
eleclib.valueedit_click =  function (el, nm, alighn, r, stroke, strokewidth, color1, color2, format, fontcolor, fontstyle){
...
eleclib.graph_click =  function (el, nm, color){
    ...
    var body = eleclib.get_staticpopupbody(el,eleclib.CHART_WIDTH,eleclib.CHART_HEIGHT, 
    ...
    var result = libutil.svg.create_element('foreignObject', body, [{
        ...
        {
        name : 'width', 
        value: eleclib.CHART_WIDTH
        },
        {
        name : 'height', 
        value : eleclib.CHART_HEIGHT
        }]);   
    ...
    var htmlbody= libutil.html.create_element( 'body' ,html, [{name: 'style', value: 'margin: 0; padding: '+ eleclib.CHART_PADDING + 'px'}]);
    ...
    script.textContent="new libutil.trendchart({ element: '"+elementId + '_popup_graph'+"', throbler : '"+
                                                         ...
                                                         (eleclib.CHART_WIDTH - 2* eleclib.CHART_PADDING) + ", height: " +
                                                         (eleclib.CHART_HEIGHT - 2* eleclib.CHART_PADDING)+ ", r: 5 , background: [[0 , '#222'],[0.5 , '#444'],[1 , '#222']]});\n"+
...
eleclib.regulator_click =  function (el, smp){
    ...
    var getbody = function(){
        return eleclib.get_staticpopupbody(el,eleclib.REGULATOR_WIDTH ,
            smp ? eleclib.REGULATOR_S_HEIGHT : eleclib.REGULATOR_F_HEIGHT, 
            function() {
    ...
    try{
        ...
        {
            name : 'y', 
            value:  smp ? 170 : 170 + (eleclib.REGULATOR_F_HEIGHT-eleclib.REGULATOR_S_HEIGHT)
        },
        {
            name : 'width', 
            value: 240
