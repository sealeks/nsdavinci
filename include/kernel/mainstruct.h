...
// dcb
    ...
    private:
        ...
        num64 level_;
        num64 appid_;
        num8 debugmessage_[LOGMESSAGE_STRINGSIZE + 2];
    } *pdebugstruct;
    ...
    private:
        ...
        num32 istext_;
        num32 type_;
        num8 strvalue_[DVNCI_MAXVALUESTRSIZE + 2];
    } *pcommandstruct;
