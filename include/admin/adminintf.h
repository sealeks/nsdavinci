...
namespace dvnci {
    namespace admin {
        ...
        public:
            ...
            virtual void   reporthistory(num32 val) = 0;
            virtual num32  reporthistory() const = 0;
            virtual void   reportsubdelt(num32 val) = 0;
            virtual num32  reportsubdelt() const = 0;
        ...
        public:
            ...
            virtual void   chanalnum(num32 val) = 0;
            virtual num32 chanalnum() const = 0;
            virtual void   portnum(num32 val) = 0;
            ...
            virtual void   grouprate(num32 val) = 0;
            virtual num32 grouprate() const = 0;
            virtual void   trycount(num32 val) = 0;
            virtual num32 trycount() const = 0;
            virtual void   blocksize(num32 val) = 0;
            virtual num32 blocksize() const = 0;
            virtual void   archblocksize(num32 val) = 0;
            virtual num32 archblocksize() const = 0;
            virtual void   utiloperation(bool val) = 0;
            virtual bool utiloperation() const = 0;
            virtual void   indicateto(num32 val) = 0;
            virtual num32 indicateto() const = 0;
            virtual lcltype local() const = 0;
            virtual void local(lcltype val ) = 0;
            virtual num16 synctype() const = 0;
            virtual void synctype(num16 val ) = 0;
            virtual num16 ver() const = 0;
            virtual void ver(num16 val ) = 0;
