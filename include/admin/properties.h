...
const propidtype PROPERTY_USERFILTER = 0x113;
const propidtype PROPERTY_USERROLE = 0x114;
const propidtype PROPERTY_NAME_USERLEVEL=0x0115;
const propidtype PROPERTY_ACCESSRULENAME = 0x120;
const propidtype PROPERTY_ACCESSRULEUSER = 0x121;
const propidtype PROPERTY_ACCESSRULEHOST = 0x122;
...
const propidtype PROPERTY_ACCESSRULEFILTER = 0x126;
const propidtype PROPERTY_ACCESSRULEROLE = 0x127;
const propidtype PROPERTY_ACCESSRULEPROT = 0x128;
...
const propidtype PROPERTY_MMS_PROTOCOL=0x0384;
const propidtype PROPERTY_IEC60870_PROTOCOL=0x0385;
...
const propidtype PROPERTY_SERVER_NAME=0x0375;
...
const propidtype PROPERTY_MMSDOMAIN=0x0479;
