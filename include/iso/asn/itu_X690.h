    ...
    namespace asn1 {
        namespace x690 {
            ...
            public:
                ...
                oarchive(encoding_rule rul = boost::iso::BER_ENCODING) : boost::iso::base_oarchive(), rule_(rul) {
                }
            ...
            class iarchive : public boost::iso::base_iarchive {
            ...
            public:
                ...
                iarchive() : boost::iso::base_iarchive() {
                }
