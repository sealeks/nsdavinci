...
namespace boost {
    namespace itu {
        ...
        namespace x226impl {
            ...
            static asn_coder_ptr build_by_syntaxes(const oid_type& asyntax, const encoding_rule& tsyntax) {

                switch (tsyntax) {
                    case BER_ENCODING:
                    case DER_ENCODING:
                    case CER_ENCODING: return asn_coder_ptr(new x690_archive(asyntax, tsyntax));
                    default:
                    {
                    }
                }
