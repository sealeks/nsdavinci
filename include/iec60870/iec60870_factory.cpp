...
namespace prot80670 {
    ...
    iec60870_factory::iec60870_factory(IEC_PROTOCOL prot, chanalnum_type chnm,
            const iec_option& opt, iec60870_data_listener_ptr listr) {
    ...
    iec60870_thread_ptr iec60870_factory::create(IEC_PROTOCOL prot, chanalnum_type chnm, const iec_option& opt,
