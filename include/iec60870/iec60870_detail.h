...
#define _IEC60870_WIN64_MGW_
#elif defined(__MINGW32__)
#define _IEC60870_WIN32_MGW_
#elif defined(_MSC_VER) && defined(_WIN64)
#define _IEC60870_WIN64_VC_ 
#elif defined(_MSC_VER) 
#define _IEC60870_WIN32_VC_ 
#elif defined(__GNUC__) && defined(__amd64__)
#define _IEC60870_LIN64_GNU_ 
#elif defined(__GNUC__)
#define _IEC60870_LIN32_GNU_ 
#else
#error PlatformXCompiler spec dont defined
#endif

#if defined(_IEC60870_WIN32_MGW_) || defined(_IEC60870_WIN32_VC_)
#define _IEC60870_WIN32_
#elif defined(_IEC60870_WIN64_MGW_) || defined(_IEC60870_WIN64_VC_)
#define _IEC60870_WIN64_
#elif defined(_IEC60870_LIN32_GNU_)
#define _IEC60870_LIN32_
#elif defined(_IEC60870_LIN64_GNU_)
#define _IEC60870_LIN64_
#else
#error Platform spec dont defined
#endif

#if defined(_IEC60870_WIN32_) || defined(_IEC60870_WIN64_)
#define _IEC60870_WIN_
#elif defined(_IEC60870_LIN32_GNU_) || defined(_IEC60870_LIN64_GNU_)
#define _IEC60870_LIN_
#else
#error Platform spec dont defined
#endif
...
#define IEC60870_EXCLUSIVE_LOCK(a)  boost::mutex::scoped_lock thlock( a );
#define IEC60870_TRY_LOCK(a)  boost::mutex::scoped_try_lock( a )
    ...
    public:
        ...
        iec_option(const std::string& vl, baudrate_type br = IEC870_BAUNDRATE_9600) : opton_(vl), baundrate_(br) {
        };
