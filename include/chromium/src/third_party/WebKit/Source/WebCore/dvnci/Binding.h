...
namespace WebCore {
    ...
    const int DVNCI_EXECUTE_ADDUSER = 6;
    const int DVNCI_EXECUTE_REMOVEUSER = 7;
    const int DVNCI_EXECUTE_CHANGEUSERPASS =8;    
    const int DVNCI_EXECUTE_CHANGEUSERACCESS =9;    
